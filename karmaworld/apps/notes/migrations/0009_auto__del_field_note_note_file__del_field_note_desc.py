...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Note.note_file'
        db.delete_column('notes_note', 'note_file')

        # Deleting field 'Note.desc'
        db.delete_column('notes_note', 'desc')


    def backwards(self, orm):
        # Adding field 'Note.note_file'
        db.add_column('notes_note', 'note_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Note.desc'
        db.add_column('notes_note', 'desc',
                      self.gf('django.db.models.fields.TextField')(max_length=511, null=True, blank=True),
                      keep_default=False)
