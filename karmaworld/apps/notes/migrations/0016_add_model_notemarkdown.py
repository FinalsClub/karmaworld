...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NoteMarkdown'
        db.create_table(u'notes_notemarkdown', (
            ('note', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['notes.Note'], unique=True, primary_key=True)),
            ('markdown', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'notes', ['NoteMarkdown'])


    def backwards(self, orm):
        # Deleting model 'NoteMarkdown'
        db.delete_table(u'notes_notemarkdown')
