...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Note.download_url'
        db.delete_column('notes_note', 'download_url')

        # Deleting field 'Note.embed_url'
        db.delete_column('notes_note', 'embed_url')

        # Adding field 'Note.gdrive_url'
        db.add_column('notes_note', 'gdrive_url',
                      self.gf('django.db.models.fields.URLField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Note.download_url'
        db.add_column('notes_note', 'download_url',
                      self.gf('django.db.models.fields.URLField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Note.embed_url'
        db.add_column('notes_note', 'embed_url',
                      self.gf('django.db.models.fields.URLField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Note.gdrive_url'
        db.delete_column('notes_note', 'gdrive_url')
