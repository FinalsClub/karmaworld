...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Note.pdf_file'
        db.delete_column(u'notes_note', 'pdf_file')

        # Deleting field 'Note.file_type'
        db.delete_column(u'notes_note', 'file_type')

        # Deleting field 'Note.year'
        db.delete_column(u'notes_note', 'year')

        # Deleting field 'Note.html'
        db.delete_column(u'notes_note', 'html')

        # Deleting field 'Note.static_html'
        db.delete_column(u'notes_note', 'static_html')


    def backwards(self, orm):
        # Adding field 'Note.pdf_file'
        db.add_column(u'notes_note', 'pdf_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Note.file_type'
        db.add_column(u'notes_note', 'file_type',
                      self.gf('django.db.models.fields.CharField')(default='???', max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Note.year'
        db.add_column(u'notes_note', 'year',
                      self.gf('django.db.models.fields.IntegerField')(default=2014, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Note.html'
        db.add_column(u'notes_note', 'html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Note.static_html'
        db.add_column(u'notes_note', 'static_html',
