...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailParsingHIT'
        db.create_table(u'quizzes_emailparsinghit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('HITId', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'quizzes', ['EmailParsingHIT'])

        # Adding M2M table for field documents on 'EmailParsingHIT'
        m2m_table_name = db.shorten_name(u'quizzes_emailparsinghit_documents')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('emailparsinghit', models.ForeignKey(orm[u'quizzes.emailparsinghit'], null=False)),
            ('note', models.ForeignKey(orm[u'notes.note'], null=False))
        ))
        db.create_unique(m2m_table_name, ['emailparsinghit_id', 'note_id'])


    def backwards(self, orm):
        # Deleting model 'EmailParsingHIT'
        db.delete_table(u'quizzes_emailparsinghit')

        # Removing M2M table for field documents on 'EmailParsingHIT'
        db.delete_table(db.shorten_name(u'quizzes_emailparsinghit_documents'))
    ...
    models = {
        ...
        u'quizzes.emailparsinghit': {
            'HITId': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'Meta': {'object_name': 'EmailParsingHIT'},
            'documents': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['notes.Note']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'quizzes.keywordextractionhit': {
            'HITId': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'Meta': {'object_name': 'KeywordExtractionHIT'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
