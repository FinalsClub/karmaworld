...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CourseKarmaEvent', fields ['points', 'user', 'timestamp']
        db.create_unique(u'users_coursekarmaevent', ['points', 'user_id', 'timestamp'])

        # Adding unique constraint on 'NoteKarmaEvent', fields ['points', 'user', 'timestamp']
        db.create_unique(u'users_notekarmaevent', ['points', 'user_id', 'timestamp'])

        # Adding unique constraint on 'GenericKarmaEvent', fields ['points', 'user', 'timestamp']
        db.create_unique(u'users_generickarmaevent', ['points', 'user_id', 'timestamp'])


    def backwards(self, orm):
        # Removing unique constraint on 'GenericKarmaEvent', fields ['points', 'user', 'timestamp']
        db.delete_unique(u'users_generickarmaevent', ['points', 'user_id', 'timestamp'])

        # Removing unique constraint on 'NoteKarmaEvent', fields ['points', 'user', 'timestamp']
        db.delete_unique(u'users_notekarmaevent', ['points', 'user_id', 'timestamp'])

        # Removing unique constraint on 'CourseKarmaEvent', fields ['points', 'user', 'timestamp']
        db.delete_unique(u'users_coursekarmaevent', ['points', 'user_id', 'timestamp'])
